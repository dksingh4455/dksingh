    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-start justify-center h-full max-w-screen-lg mx-auto px-6">
          {/* Title */}
          <h1 className="text-white text-6xl font-bold mb-6">Contact Us</h1>
          ...
          <div className="flex gap-4">
            ...
            <button
              className="px-6 py-3 bg-orange-500 text-white text-lg font-semibold rounded-lg shadow-md hover:bg-orange-600"
            >
              Contact Us
            </button>
          </div>
      ...
      <div className="bg-white py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-12">
            <h3 className="text-green-600 font-bold text-lg uppercase mb-2">
              Contact Us
            </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            {/* Right Info */}
            <div className="bg-orange-400 p-8 rounded-lg shadow-lg text-white">
